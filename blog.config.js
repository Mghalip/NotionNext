...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mahprat Ghalip', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'MG Public Knowledge Hub', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mghalip.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Standardized Test Prep', // 网站关键词 英文逗号隔开
